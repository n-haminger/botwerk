...
This is the top-level `~/.botwerk` directory.
...
- `~/.botwerk/agents.json` is the single source of truth for all sub-agent
...
`~/.botwerk/SHAREDMEMORY.md` contains facts shared across all agents
