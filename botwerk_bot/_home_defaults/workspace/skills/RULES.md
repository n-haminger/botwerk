...
This directory is part of botwerk's three-way skill sync.
...
- Priority when duplicates exist: `botwerk > claude > codex`.
- Real directories are never overwritten.
- Broken botwerk-managed links are cleaned automatically.
