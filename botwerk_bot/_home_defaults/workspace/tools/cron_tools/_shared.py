...
from botwerk_bot._home_defaults.workspace.tools._tool_shared import (
    available_ids,
    find_by_id,
...
BOTWERK_HOME = Path(os.environ.get("BOTWERK_HOME", "~/.botwerk")).expanduser()
CONFIG_PATH = BOTWERK_HOME / "config" / "config.json"
JOBS_PATH = BOTWERK_HOME / "cron_jobs.json"
CRON_TASKS_DIR = BOTWERK_HOME / "workspace" / "cron_tasks"
