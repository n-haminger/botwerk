...
from botwerk_bot.bot.sender import SendRichOpts, send_files_from_text, send_rich
from botwerk_bot.bot.streaming import create_stream_editor
from botwerk_bot.bot.typing import TypingContext
from botwerk_bot.cli.coalescer import CoalesceConfig, StreamCoalescer
...
if TYPE_CHECKING:
    ...
    from botwerk_bot.config import StreamingConfig
