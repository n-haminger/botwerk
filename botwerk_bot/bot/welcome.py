...
from botwerk_bot.text.response_format import SEP

if TYPE_CHECKING:
    from botwerk_bot.cli.auth import AuthResult
...
WELCOME_CALLBACKS: dict[str, str] = {
    "w:1": (
        "Hey, I just set up botwerk and I want you to get to know me. "
