...
from botwerk_bot.config import _GEMINI_ALIASES, CLAUDE_MODELS, get_gemini_models
...
def resolve_cli_config(
    ...
    *,
    ...
    Raises:
        BotwerkError: If model validation fails
    """
    ...
    return TaskExecutionConfig(
        ...
        working_dir=base_config.botwerk_home,
