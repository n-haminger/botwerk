"""Service management CLI subcommands (``botwerk service ...``)."""
...
def print_service_help() -> None:
    ...
    table.add_column()
    table.add_row("botwerk service install", "Install and start background service")
    table.add_row("botwerk service status", "Show service status")
    table.add_row("botwerk service start", "Start the service")
    table.add_row("botwerk service stop", "Stop the service")
    table.add_row("botwerk service logs", "View live logs")
    table.add_row("botwerk service uninstall", "Remove the service")
    _console.print(
...
def cmd_service(args: list[str]) -> None:
    """Handle botwerk service <subcommand>'."""
    from botwerk_bot.infra.service import (
        install_service,
        print_service_logs,
