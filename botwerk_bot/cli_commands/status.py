"""Status display CLI commands (``botwerk status``, ``botwerk help``)."""
...
def build_status_lines(status: StatusSummary, *, paths: BotwerkPaths) -> list[str]:
    ...
    lines.append(f"  Home:       [cyan]{paths.botwerk_home}[/cyan]")
...
def print_status() -> None:
    ...
    from botwerk_bot.cli_commands.agents import load_agents_registry, print_agents_status
...
def print_usage() -> None:
    ...
    table.add_row("botwerk uninstall", "Remove everything and uninstall")
    ...
    if _is_configured():
        ...
        _console.print(
            Panel(
                ...
                "Run [bold]botwerk[/bold] to start the setup wizard.",
