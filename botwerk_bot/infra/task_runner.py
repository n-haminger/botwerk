...
if TYPE_CHECKING:
    ...
    from botwerk_bot.infra.base_task_observer import BaseTaskObserver
...
async def run_oneshot_task(
    ...
    *,
    ...
    """
    from botwerk_bot.cron.execution import build_cmd, execute_one_shot
...
async def execute_in_task_folder(  # noqa: PLR0913
    ...
    *,
    ...
    """
    from botwerk_bot.cron.dependency_queue import get_dependency_queue
    from botwerk_bot.cron.execution import enrich_instruction
