...
from botwerk_bot.bus.cron_sanitize import sanitize_cron_result_text
from botwerk_bot.bus.envelope import Envelope, Origin
from botwerk_bot.matrix.sender import MatrixSendOpts
...
class MatrixTransport:
    ...
    async def _broadcast(self, text: str) -> None:
        ...
        from botwerk_bot.matrix.bot import resolve_broadcast_rooms
