...
from botwerk_bot.background import (
    BackgroundSubmit,
    BackgroundTask,
)
from botwerk_bot.cli.process_registry import ProcessRegistry
from botwerk_bot.cli.service import CLIService, CLIServiceConfig
...
from botwerk_bot.orchestrator.directives import parse_directives
from botwerk_bot.orchestrator.flows import (
    StreamingCallbacks,
    heartbeat_flow,
    named_session_flow,
...
from botwerk_bot.orchestrator.providers import ProviderManager
from botwerk_bot.orchestrator.registry import CommandRegistry, OrchestratorResult
from botwerk_bot.security import detect_suspicious_patterns
from botwerk_bot.session import SessionKey, SessionManager
from botwerk_bot.session.manager import SessionData
from botwerk_bot.session.named import NamedSessionRegistry
from botwerk_bot.webhook.manager import WebhookManager
from botwerk_bot.workspace.paths import BotwerkPaths

if TYPE_CHECKING:
    from botwerk_bot.background import BackgroundObserver
    from botwerk_bot.bus.bus import MessageBus
    from botwerk_bot.config import ModelRegistry
...
class Orchestrator:
    ...
    async def create(
        ...
        *,
        ...
        """
        from botwerk_bot.orchestrator.lifecycle import create_orchestrator
    ...
    def register_multiagent_commands(self) -> None:
        ...
        """
        from botwerk_bot.multiagent.commands import (
            cmd_agent_restart,
            cmd_agent_start,
            cmd_agent_stop,
            cmd_agents,
    ...
    def submit_background_task(
        ...
        from botwerk_bot.cli.param_resolver import resolve_cli_config
    ...
    async def _start_api_server(
        ...
        from botwerk_bot.orchestrator.lifecycle import start_api_server
    ...
    async def inject_prompt(
        ...
        *,
        ...
        from botwerk_bot.orchestrator.injection import _inject_prompt

        return await _inject_prompt(self, prompt, chat_id, label, topic_id=topic_id)

    async def shutdown(self) -> None:
        """Cleanup on bot shutdown."""
        from botwerk_bot.orchestrator.lifecycle import shutdown
