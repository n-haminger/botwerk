...
from botwerk_bot.background import BackgroundObserver, BackgroundResult

if TYPE_CHECKING:
    from botwerk_bot.bus.bus import MessageBus
from botwerk_bot.cleanup import CleanupObserver
...
from botwerk_bot.workspace.init import watch_rule_files
from botwerk_bot.workspace.paths import BotwerkPaths
from botwerk_bot.workspace.skill_sync import watch_skill_sync
...
class ObserverManager:
    ...
    def __init__(self, config: AgentConfig, paths: BotwerkPaths) -> None:
        self._config = config
        self._paths = paths
    ...
    def wire_to_bus(
        ...
        *,
        ...
        """
        from botwerk_bot.bus.adapters import (
