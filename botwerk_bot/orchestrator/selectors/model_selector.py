...
from botwerk_bot.config import CLAUDE_MODELS_ORDERED, get_gemini_models, update_config_file_async
from botwerk_bot.multiagent.registry import update_agent_fields
from botwerk_bot.orchestrator.selectors.models import Button, ButtonGrid, SelectorResponse
...
async def switch_model(
    ...
    *,
    ...
    if not is_topic:
        ...
        if orch.paths.botwerk_home.parent.name == "agents":
            agents_path = orch.paths.botwerk_home.parent.parent / "agents.json"
