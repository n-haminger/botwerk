...
from botwerk_bot.tasks.models import TaskEntry, TaskInFlight, TaskResult, TaskSubmit

if TYPE_CHECKING:
    from pathlib import Path

    from botwerk_bot.cli.service import CLIService
    from botwerk_bot.config import TasksConfig
...
class TaskHub:
    ...
    def set_agent_paths(self, agent_name: str, paths: BotwerkPaths) -> None:
