...
class TestHasMedia:
    def test_text_only(self) -> None:
        from botwerk_bot.bot.media import has_media
...
class TestIsMediaAddressed:
    def test_reply_to_bot(self) -> None:
        from botwerk_bot.bot.media import is_media_addressed
...
class TestIsMessageAddressed:
    ...
    def test_reply_to_bot(self) -> None:
        from botwerk_bot.bot.media import is_message_addressed
...
class TestResolveMedia:
    def test_photo_extraction(self) -> None:
        from botwerk_bot.bot.media import _resolve_media
...
class TestUpdateIndex:
    def test_builds_index(self, tmp_path: Path) -> None:
        from botwerk_bot.bot.media import update_index
...
class TestTelegramBuildMediaPrompt:
    def test_includes_telegram_transport(self, tmp_path: Path) -> None:
        from botwerk_bot.bot.media import build_media_prompt
