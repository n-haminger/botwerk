...
from botwerk_bot.cli.claude_provider import (
    ClaudeCodeCLI,
    _add_opt,
    _log_cmd,
    _parse_response,
...
_EXEC_PATH = "botwerk_bot.cli.executor.asyncio.create_subprocess_exec"
...
class TestLogCmd:
    def test_truncates_long_values_after_flags(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        with caplog.at_level(logging.INFO, logger="botwerk_bot.cli.claude_provider"):
            _log_cmd(cmd)
