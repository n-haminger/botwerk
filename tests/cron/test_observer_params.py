...
from botwerk_bot.cli.param_resolver import TaskExecutionConfig, TaskOverrides
from botwerk_bot.config import AgentConfig
from botwerk_bot.cron.execution import OneShotCommand
...
class TestResolveExecutionConfig:
    ...
    def test_resolve_execution_config_no_overrides(
        ...
        with patch("botwerk_bot.infra.base_task_observer.resolve_cli_config") as mock_resolve:
...
class TestExecuteJobWithOverrides:
    ...
    async def test_execute_job_with_model_override(
        ...
        with (
            ...
            patch("botwerk_bot.cron.execution.build_cmd") as mock_build,
            patch("botwerk_bot.infra.base_task_observer.resolve_cli_config") as mock_resolve,
