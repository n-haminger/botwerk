...
async def test_orchestrator_starts_cache_observer(mock_codex_cache: CodexModelCache) -> None:
    ...
    with (
        patch("botwerk_bot.orchestrator.observers.CodexCacheObserver", return_value=mock_observer),
        patch("botwerk_bot.orchestrator.lifecycle.resolve_paths"),
        patch("botwerk_bot.orchestrator.lifecycle.inject_runtime_environment"),
